...
#include "kachaka_interfaces/msg/detail/object_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const kachaka_interfaces::msg::ObjectDetection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  kachaka_interfaces::msg::ObjectDetection & ros_message)
{
  // Member: label
  cdr >> ros_message.label;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kachaka_interfaces::msg::ObjectDetection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kachaka_interfaces::msg::ObjectDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kachaka_interfaces::msg::ObjectDetection *>(
    untyped_ros_message);
...
{
  return &kachaka_interfaces::msg::typesupport_fastrtps_cpp::_ObjectDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kachaka_interfaces, msg, ObjectDetection)() {
  return &kachaka_interfaces::msg::typesupport_fastrtps_cpp::_ObjectDetection__handle;
}
